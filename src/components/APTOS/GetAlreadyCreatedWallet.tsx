							...
							<div className="space-y-1 ">
								<div className="gap-3 flex items-center">
									...
									<button onClick={handleApiCall} disabled={fetchingResponse} 
										className={cn(" flex self-stretch items-center justify-center md:w-1/3  bg-[var(--ifm-color-primary)] border-none py-[0.4rem] px-[0.8rem] rounded-md md:text-lg cursor-pointer",
